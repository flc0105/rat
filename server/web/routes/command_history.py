...
def create_command_history_blueprint(server_instance):
    ...
    def get_command_history(client_id):
        return responder.json_endpoint(
            lambda: command_web_service.get_command_history(client_id),
    ...
    def get_full_command_history(client_id):
        return responder.json_endpoint(
            lambda: command_web_service.get_command_execution_history(client_id),
            default_error_status=500
        )
    ...
    def clear_command_history(client_id):
        return responder.json_endpoint(
            lambda: command_web_service.clear_command_history(client_id),
            default_error_status=500
        )
    ...
    def set_command_history_pinned(client_id):
        def _execute():
            ...
            return command_web_service.set_command_history_pinned(
                client_id,
                command,
    ...
    def move_command_history_pinned(client_id):
        def _execute():
            ...
            return command_web_service.move_command_history_pinned(
                client_id,
                command,
                direction,
            )
    ...
    def delete_command_execution_history_entry(client_id, entry_id):
        return responder.json_endpoint(
            lambda: command_web_service.delete_command_execution_history_entry(client_id, entry_id),
            default_error_status=500
        )
