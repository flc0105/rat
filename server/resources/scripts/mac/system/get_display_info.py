SCRIPT_METADATA = {
    "name": "mac/system/get_display_info",
    "display_name": "List Displays",
    "description": "Get display information on macOS",
    "platforms": ["darwin"],
    "category": "System",
    "params": []
}
...
print(json.dumps(list_displays(), ensure_ascii=False, indent=2))