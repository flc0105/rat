SCRIPT_METADATA = {
    "name": "linux/recon/port_inspect",
    "display_name": "Inspect Port",
    "description": "Examine a specific TCP port, showing listening socket state and all active connections with process info",
    "platforms": ["linux"],
    "category": "Recon",
    "params": [
        {
            ...
            "required": False,
            "default": 9999,
            "description": "Target TCP port to inspect"
        }
    ]
}
...
TARGET_PORT = kwargs.get("port", 9999)
