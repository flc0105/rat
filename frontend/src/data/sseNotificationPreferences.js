export const DEFAULT_SSE_NOTIFICATION_PREFERENCES = {
  ...
  events: {
    ...
    external_tool_oneshot_started: false,
    external_tool_oneshot_completed: false,
    external_tool_oneshot_error: false,
...
export const SSE_NOTIFICATION_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'external_tool_oneshot_started', label: 'Oneshot started' },
      { key: 'external_tool_oneshot_completed', label: 'Oneshot completed' },
      { key: 'external_tool_oneshot_error', label: 'Oneshot error' },
  ...
  },
  {
    title: 'Agent Build',
    items: [
      { key: 'agent_build_started', label: 'Build started' },
