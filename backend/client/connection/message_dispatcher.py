...
class ClientInboundMessageDispatcher:
    ...
    IMMEDIATE_MESSAGE_TYPES = {MSG_TYPE_HEARTBEAT, MSG_TYPE_HEARTBEAT_ACK, MSG_TYPE_CANCEL, MSG_TYPE_PTY_OPEN, MSG_TYPE_PTY_INPUT, MSG_TYPE_PTY_RESIZE, MSG_TYPE_PTY_CLOSE, MSG_TYPE_SCREEN_OPEN, MSG_TYPE_SCREEN_CONFIG, MSG_TYPE_SCREEN_CLOSE, MSG_TYPE_SCREEN_INPUT}
