...
class ServerInboundMessageDispatcher:
    ...
    IMMEDIATE_MESSAGE_TYPES = {MSG_TYPE_RESULT, MSG_TYPE_HEARTBEAT_ACK, MSG_TYPE_PTY_OPENED, MSG_TYPE_PTY_OUTPUT, MSG_TYPE_PTY_CLOSED, MSG_TYPE_PTY_ERROR, MSG_TYPE_SCREEN_OPENED, MSG_TYPE_SCREEN_FRAME, MSG_TYPE_SCREEN_CLOSED, MSG_TYPE_SCREEN_ERROR}
