class WebDeviceMonitorApi:
    ...
    def open_monitor(self, client_id: str, tab_id: str, *, channels=None, intervals=None, options=None) -> dict:
    ...
    def update_monitor(self, monitor_session_id: str, tab_id: str, *, channels=None, intervals=None, options=None) -> dict:
