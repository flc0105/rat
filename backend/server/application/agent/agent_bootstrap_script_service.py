class AgentBootstrapScriptService:
    ...
    def _generate_python_script(self, server_host, server_port, web_host, web_port, web_scheme='http'):
...
'''
    ...
    def _generate_powershell_script(self, server_host, server_port, web_port):
